...
from ..database.repository import find_cart_by_id, find_menu_item_by_id
...
def add_item_to_cart_endpoint(cart_id):
    ...
    # Validation: ensure the item exists in the menu
    if not find_menu_item_by_id(item_id):
        raise CheekyApiError("Item not found")
