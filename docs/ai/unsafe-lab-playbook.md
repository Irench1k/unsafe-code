...
Deep dive: `docs/ai/http-syntax.md` and `docs/ai/spec-vs-demo.md`.
...
Quick refs: `docs/ai/characters.md`, `AGENTS.md`.

---

## 6) Document Map (read on demand)

- **Knowledge index**: `docs/ai/README.md` (scopes for every AI doc).
...
## Ownership Philosophy (keep in mind)

1. Consult the relevant doc for conventions and patterns.
2. Apply invariants as hard constraints (see `invariants.md`).
3. Use judgment for implementation details; prefer realistic, production-quality code.
4. Optimize specs for inheritance and minimal overrides.
5. Prioritize test integrity over green metrics—failing tests are signals.
